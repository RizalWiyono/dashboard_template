...
<html>
<head>
    <title>RRGraph - Color Analyze</title> 
    <meta charset="utf-8">
...
<body >
                    ...
                    <div class="main-sales">
                        <div class="distance-content">
                            <div class="header-content">
                                <h1 class="title-content">Color Analyze - <?=$_GET['item']?></h1>
                                
                                <div class="range" style="width: 100%;" align="right">
                                    <?php
                                    if($_GET['date'] == 'One Month Last'){
                                    ?>
                                    <a href="?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&item=<?=$_GET['item']?>&date=One Month Last">
                                    ...
                                    ?>
                                    <a href="?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&item=<?=$_GET['item']?>&date=30 Days">
                                    ...
                                    ?>
                                    <a href="?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&item=<?=$_GET['item']?>&date=One Year Last">
                                    ...
                                    <div class="dropdown-menu dd_costum" aria-labelledby="dropdownMenu2">
                                        <a href="?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&item=<?=$_GET['item']?>&date=Last Month" id="last_month" class="dropdown-item" type="button" value="Last Month">Last Month</a>
                                        <a href="?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&item=<?=$_GET['item']?>&date=This Year" id="this_year" class="dropdown-item" type="button" value="This Year">This Year</a>
                                        <a href="?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&item=<?=$_GET['item']?>&date=Last Year" id="last_year" class="dropdown-item" type="button" value="Last Year">Last Year</a>
                                        <a href="?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&item=<?=$_GET['item']?>&date=All Time" id="all_time" class="dropdown-item" type="button" value="All Time">All Time</a>
                                    </div>
                                    <?php
                                    }else{
                                    ?>
                            ...
                            <div class="content-in-item"> 
                                ...
                                ?>
                                    ...
                                    if(isset($_GET['todate'])){
                                    ?>
                                    <a href="?market=All Marketplace&type=All&item=<?=$_GET['item']?>&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                    <?php
                                    }else{
                                    ?>
                                    <a href="?market=All Marketplace&type=All&item=<?=$_GET['item']?>&date=<?=$_GET['date']?>">
                                    <?php
                                    }
                                    ?>
                                ...
                                ?>
                                    ...
                                    if(isset($_GET['todate'])){
                                    ?>
                                    <a href="?market=All Marketplace&type=GR-Brandearth&item=<?=$_GET['item']?>&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                    <?php
                                    }else{
                                    ?>
                                    <a href="?market=All Marketplace&type=GR-Brandearth&item=<?=$_GET['item']?>&date=<?=$_GET['date']?>">
                                    <?php
                                    }
                                    ?>
                                ...
                                ?>
                                    ...
                                    if(isset($_GET['todate'])){
                                    ?>
                                    <a href="?market=All Marketplace&type=GR-RRGraph&item=<?=$_GET['item']?>&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                    <?php
                                    }else{
                                    ?>
                                    <a href="?market=All Marketplace&type=GR-RRGraph&item=<?=$_GET['item']?>&date=<?=$_GET['date']?>">
                                    <?php
                                    }
                                    ?>
                                ...
                                ?>
                                    ...
                                    if(isset($_GET['todate'])){
                                    ?>
                                    <a href="?market=All Marketplace&type=Templatemonster&item=<?=$_GET['item']?>&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                    <?php
                                    }else{
                                    ?>
                                    <a href="?market=All Marketplace&type=Templatemonster&item=<?=$_GET['item']?>&date=<?=$_GET['date']?>">
                                    <?php
                                    }
                                    ?>
                                ...
                                ?>
                                    ...
                                    if(isset($_GET['todate'])){
                                    ?>
                                    <a href="?market=All Marketplace&type=Creativemarket&item=<?=$_GET['item']?>&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                    <?php
                                    }else{
                                    ?>
                                    <a href="?market=All Marketplace&type=Creativemarket&item=<?=$_GET['item']?>&date=<?=$_GET['date']?>">
                                    <?php
                                    }
                                    ?>
                                ...
                                ?>
                                    ...
                                    if(isset($_GET['todate'])){
                                    ?>
                                    <a href="?market=All Marketplace&type=RRSlide&item=<?=$_GET['item']?>&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                    <?php
                                    }else{
                                    ?>
                                    <a href="?market=All Marketplace&type=RRSlide&item=<?=$_GET['item']?>&date=<?=$_GET['date']?>">
                                    <?php
                                    }
                                    ?>
                                ...
                                <h1 class="linked_item" align="right">
                                    <?php
                                    if($_GET['item'] == 'Sales'){
                                        if(isset($_GET['todate'])){
                                        ?>
                                        <a class="title-linked-item-active mr-3" href="?market=All Marketplace&type=<?=$_GET['type']?>&item=Sales&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                        <?php
                                        }else{
                                        ?>
                                        <a class="title-linked-item-active mr-3" href="?market=All Marketplace&type=<?=$_GET['type']?>&item=Sales&date=<?=$_GET['date']?>">
                                        <?php
                                        }
                                    ?>
                                    <?php
                                        ...
                                        if(isset($_GET['todate'])){
                                        ?>
                                        <a class="title-linked-item mr-3" href="?market=All Marketplace&type=<?=$_GET['type']?>&item=Sales&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                        <?php
                                        }else{
                                        ?>
                                        <a class="title-linked-item mr-3" href="?market=All Marketplace&type=<?=$_GET['type']?>&item=Sales&date=<?=$_GET['date']?>">
                                        <?php
                                        }
                                    }
                                    ?>
                                    ...
                                    <?php
                                    if($_GET['item'] == 'Product'){
                                        if(isset($_GET['todate'])){
                                        ?>
                                        <a class="title-linked-item-active" href="?market=All Marketplace&type=<?=$_GET['type']?>&item=Product>&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                        <?php
                                        }else{
                                        ?>
                                        <a class="title-linked-item-active" href="?market=All Marketplace&type=<?=$_GET['type']?>&item=Product&date=<?=$_GET['date']?>">
                                        <?php
                                        }
                                    ?>
                                    <?php
                                        ...
                                        if(isset($_GET['todate'])){
                                        ?>
                                        <a class="title-linked-item" href="?market=All Marketplace&type=<?=$_GET['type']?>&item=Product&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                        <?php
                                        }else{
                                        ?>
                                        <a class="title-linked-item" href="?market=All Marketplace&type=<?=$_GET['type']?>&item=Product&date=<?=$_GET['date']?>">
                                        <?php
                                        }
                                    }
                                    ?>
                            ...
                            <div class="barchart-content" align="center">
                                <div id="color-chart" class="chart-category"></div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="js/costum_color.js"></script> 
