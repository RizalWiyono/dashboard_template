...
<html>
<head>
    <title>RRGraph - Search Summary</title> 
    <meta charset="utf-8">
                ...
                <div class="main-content" align="left">
                    ...
                    <div class="main-header">
                        ...
                        <div class="col-md-4 search">
                            <div class="row">
                                <input class="totheend" onfocus="if(typeof moveCursorToEnd != 'undefined') moveCursorToEnd(this, true)" autofocus="autofocus" type="text" name="" id="search" placeholder="Template name here" value="<?=$_POST['search']?>" onInput="search_it()">
                                <img class="search-ic" src="../../../src/image/SEARCH-IC.svg" alt="">
                    ...
                    <div class="main-sales">
                        <div class="distance-content">
                            <div class="header-content">
                                <h1 class="title-content">Search Summary</h1>
                            </div>
                            ...
                            <div class="barchart-content" align="center">
                                <div class="item-content">
                                    <table class="table-market-item table">
                                        ...
                                        include '../../../src/connection/connection.php';
                                        $name = $_POST['search'];
                                        $sql_market = mysqli_query($connect, "SELECT name, tb_sales.market_id, color, COUNT(*) AS TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE name LIKE '%$name%' GROUP BY name ASC LIMIT 10");
                                        while($row = mysqli_fetch_array($sql_market)){
                                        ?>
