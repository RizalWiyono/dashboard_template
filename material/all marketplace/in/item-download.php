...
<html>
<head>
    <title>RRGraph - Top Item Download</title> 
    <meta charset="utf-8">
                            ...
                            <div class="content-in-item"> 
                                <div class="marketplace-item">
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat-active" name="" id="">Top Item All Marketplace</button>
                                        </a>
                                    <?php
                                    }else{
                                    ?>
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat" name="" id="">Top Item All Marketplace</button>
                                        </a>
                                    <?php
                                    }
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat-active" name="" id="">Top Item GR-Brandearth</button>
                                        </a>
                                    <?php
                                    }else{
                                    ?>
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat" name="" id="">Top Item GR-Brandearth</button>
                                        </a>
                                    <?php
                                    }
                                    ?>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat-active" name="" id="">Top Item GR-RRGraph</button>
                                        </a>
                                    <?php
                                    }else{
                                    ?>
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat" name="" id="">Top Item GR-RRGraph</button>
                                        </a>
                                    <?php
                                    }
                                    ?>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat-active" name="" id="">Top Item Creativemarket</button>
                                        </a>
                                    <?php
                                    }else{
                                    ?>
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat" name="" id="">Top Item Creativemarket</button>
                                        </a>
                                    <?php
                                    }
                                    ?>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat-active" name="" id="">Top Item Templatemonster</button>
                                        </a>
                                    <?php
                                    }else{
                                    ?>
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat" name="" id="">Top Item Templatemonster</button>
                                        </a>
                                    <?php
                                    }
                                    ?>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat-active" name="" id="">Top Item RRSlide</button>
                                        </a>
                                    <?php
                                    }else{
                                    ?>
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat" name="" id="">Top Item RRSlide</button>
                                        </a>
                                    <?php
                                    }
                                    ?>
                                    ...
                                    ?>
                                        ...
                                        if(isset($_GET['todate'])){
                                        ?>
                                        <a href="?market=All Marketplace&type=Category&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                        <?php
                                        }else{
                                        ?>
                                        <a href="?market=All Marketplace&type=Category&date=<?=$_GET['date']?>">
                                        <?php
                                        }
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat-active" name="" id="">Top Item by. Category</button>
                                        </a>
                                    <?php
                                    }else{
                                    ?>
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat" name="" id="">Top Item by. Category</button>
                                        </a>
                                    <?php
                                    }
                                    ?>
                                    ...
                                    ?>
                                        ...
                                        if(isset($_GET['todate'])){
                                        ?>
                                        <a href="?market=All Marketplace&type=Color&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                        <?php
                                        }else{
                                        ?>
                                        <a href="?market=All Marketplace&type=Color&date=<?=$_GET['date']?>">
                                        <?php
                                        }
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat-active" name="" id="">Top Item by. Color</button>
                                        </a>
                                    <?php
                                    }else{
                                    ?>
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-primary btn-market-cat" name="" id="">Top Item by. Color</button>
                                        </a>
                                    <?php
                                    }
                                    ?>
                                ...
                                <div class="select-in-item">
                                    <select class="select-item" name="" id="select_count"  >
                            ...
                            <div class="barchart-content" align="center">
                                <div class="item-content">
                                    <table class="table-market-item table">
                                        ...
                                        if($market_id == 0){
                                            if($_GET['date'] == "One Year Last" && !isset($_GET['todate'])){
                                                $param_date_1   = date('Y-m-d', strtotime("-12 month"));
                                                $param_date_2   = date('Y-m-d', strtotime("-24 month"));
                                                
                                                $query="SELECT name, tb_sales.market_id, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE date BETWEEN '$param_date_1' AND '$param_date' GROUP BY name ORDER BY TOTAL DESC, name DESC LIMIT 10";
                                            }elseif($_GET['date'] == "One Month Last"){
                                                $previous_year_month    = date('Y-m', strtotime("-1 month"));
                                                
                                                $query="SELECT name, tb_sales.market_id, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE date LIKE '%$param_year_month%' GROUP BY name ORDER BY TOTAL DESC, name DESC LIMIT 10 ";
                                            }elseif($_GET['date'] == "30 Days"){
                                                ...
                                                $query="SELECT name, tb_sales.market_id, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE date LIKE '%$previous_year_month_1%' GROUP BY name ORDER BY TOTAL DESC, name DESC LIMIT 10 ";
                                            }elseif($_GET['date'] == "This Year" && !isset($_GET['todate'])){
                                                $param_year_1   = date('Y', strtotime("-1 year"));
                                    
                                                $query="SELECT name, tb_sales.market_id, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE year=$param_year GROUP BY name ORDER BY TOTAL DESC, name DESC LIMIT 10 ";
                                            }elseif($_GET['date'] == "Last Year" && !isset($_GET['todate'])){
                                                $param_year_1   = date('Y', strtotime("-1 year"));
                                                $param_year_2   = date('Y', strtotime("-2 year"));
                                    
                                                $query="SELECT name, tb_sales.market_id, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE year=$param_year_1 GROUP BY name ORDER BY TOTAL DESC, name DESC LIMIT 10 ";
                                            ...
                                            if($_GET['date'] == "One Year Last" && !isset($_GET['todate'])){
                                                ...
                                                $query="SELECT name, tb_sales.market_id, category, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE category!='' && date BETWEEN '$param_date_1' AND '$param_date' GROUP BY category ORDER BY TOTAL DESC, name DESC LIMIT 10  ";
                                            }elseif($_GET['date'] == "One Month Last"){
                                                $previous_year_month    = date('Y-m', strtotime("-1 month"));
                                    
                                                $query="SELECT name, tb_sales.market_id, category, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE category!='' && date LIKE '%$param_year_month%' GROUP BY category ORDER BY TOTAL DESC, name DESC LIMIT 10  ";
                                            }elseif($_GET['date'] == "30 Days"){
                                                $param_date_1   = date('Y-m-d', strtotime("-30 day"));
                                                $param_date_2   = date('Y-m-d', strtotime("-60 day"));
                                                ...
                                                $query="SELECT name, tb_sales.market_id, category, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE category!='' && date LIKE '%$previous_year_month_1%' GROUP BY category ORDER BY TOTAL DESC, name DESC LIMIT 10  ";
                                            }elseif($_GET['date'] == "This Year" && !isset($_GET['todate'])){
                                                $param_year_1   = date('Y', strtotime("-1 year"));
                                    
                                                $query="SELECT name, tb_sales.market_id, category, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE category!='' && year=$param_year GROUP BY category ORDER BY TOTAL DESC, name DESC LIMIT 10  ";
                                            }elseif($_GET['date'] == "Last Year" && !isset($_GET['todate'])){
                                                $param_year_1   = date('Y', strtotime("-1 year"));
                                                $param_year_2   = date('Y', strtotime("-2 year"));
                                    
                                                $query="SELECT name, tb_sales.market_id, category, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE category!='' && year=$param_year_1 GROUP BY category ORDER BY TOTAL DESC, name DESC LIMIT 10  ";
                                            }elseif($_GET['date'] == "All Time" && !isset($_GET['todate'])){
                                            ...
                                            if($_GET['date'] == "One Year Last" && !isset($_GET['todate'])){
                                                ...
                                                $query="SELECT name, tb_sales.market_id, color, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE color!='' && date BETWEEN '$param_date_1' AND '$param_date' GROUP BY color ORDER BY TOTAL DESC, name DESC LIMIT 10  ";
                                            }elseif($_GET['date'] == "One Month Last"){
                                                $previous_year_month    = date('Y-m', strtotime("-1 month"));
                                                
                                                $query="SELECT name, tb_sales.market_id, color, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE color!='' && date LIKE '%$param_year_month%' GROUP BY color ORDER BY TOTAL DESC, name DESC LIMIT 10  ";
                                            }elseif($_GET['date'] == "30 Days"){
                                                $param_date_1   = date('Y-m-d', strtotime("-30 day"));
                                                $param_date_2   = date('Y-m-d', strtotime("-60 day"));
                                                ...
                                                $query="SELECT name, tb_sales.market_id, color, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE color!='' && date LIKE '%$previous_year_month_1%' GROUP BY color ORDER BY TOTAL DESC, name DESC LIMIT 10  ";
                                            }elseif($_GET['date'] == "This Year" && !isset($_GET['todate'])){
                                                $param_year_1   = date('Y', strtotime("-1 year"));
                                    
                                                $query="SELECT name, tb_sales.market_id, color, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE color!='' && year=$param_year GROUP BY color ORDER BY TOTAL DESC, name DESC LIMIT 10  ";
                                            }elseif($_GET['date'] == "Last Year" && !isset($_GET['todate'])){
                                                $param_year_1   = date('Y', strtotime("-1 year"));
                                                $param_year_2   = date('Y', strtotime("-2 year"));
                                    
                                                $query="SELECT name, tb_sales.market_id, color, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE color!='' && year=$param_year_1 GROUP BY color ORDER BY TOTAL DESC, name DESC LIMIT 10  ";
                                            }elseif($_GET['date'] == "All Time" && !isset($_GET['todate'])){
                                            ...
                                            if($_GET['date'] == "One Year Last" && !isset($_GET['todate'])){
                                                ...
                                                $query="SELECT name, tb_sales.market_id, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE tb_sales.market_id=$market_id && date BETWEEN '$param_date_1' AND '$param_date' GROUP BY name ORDER BY TOTAL DESC, name DESC LIMIT 10";
                                            }elseif($_GET['date'] == "One Month Last"){
                                                $previous_year_month    = date('Y-m', strtotime("-1 month"));
                                                
                                                $query="SELECT name, tb_sales.market_id, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE tb_sales.market_id=$market_id && date LIKE '%$param_year_month%' GROUP BY name ORDER BY TOTAL DESC, name DESC LIMIT 10 ";
                                            }elseif($_GET['date'] == "30 Days"){
                                                $param_date_1   = date('Y-m-d', strtotime("-30 day"));
                                                $param_date_2   = date('Y-m-d', strtotime("-60 day"));
                                                ...
                                                $query="SELECT name, tb_sales.market_id, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE tb_sales.market_id=$market_id && date LIKE '%$previous_year_month_1%' GROUP BY name ORDER BY TOTAL DESC, name DESC LIMIT 10 ";
                                            }elseif($_GET['date'] == "This Year" && !isset($_GET['todate'])){
                                                $param_year_1   = date('Y', strtotime("-1 year"));
                                    
                                                $query="SELECT name, tb_sales.market_id, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE tb_sales.market_id=$market_id && year=$param_year GROUP BY name ORDER BY TOTAL DESC, name DESC LIMIT 10 ";
                                            }elseif($_GET['date'] == "Last Year" && !isset($_GET['todate'])){
                                                $param_year_1   = date('Y', strtotime("-1 year"));
                                                $param_year_2   = date('Y', strtotime("-2 year"));
                                    
                                                $query="SELECT name, tb_sales.market_id, COUNT(*) as TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE tb_sales.market_id=$market_id && year=$param_year_1 GROUP BY name ORDER BY TOTAL DESC, name DESC LIMIT 10 ";
                                            }elseif($_GET['date'] == "All Time" && !isset($_GET['todate'])){
