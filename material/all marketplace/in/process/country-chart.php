...
$param_year             = date("Y");
    ...
    if($item_market == 0){
        if($date == 'One Month Last' && !isset($_POST['todate'])){
            ...
            $query="SELECT country, COUNT(*) AS TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE country!='' && date LIKE '%$param_year_month%' GROUP BY country DESC ORDER BY TOTAL DESC";
            ...
            $query="SELECT country, COUNT(*) AS TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE country!='' && date LIKE '%$param_year%' GROUP BY country DESC ORDER BY TOTAL DESC";
            $result = mysqli_query($connect, $query);
            while($row =mysqli_fetch_array($result)) {
                $param_item = $row["country"];
            ...
            $query="SELECT country, COUNT(*) AS TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE country!='' && date LIKE '%$param_year_1%'  GROUP BY country DESC ORDER BY TOTAL DESC";
            $result = mysqli_query($connect, $query);
            while($row =mysqli_fetch_array($result)) {
                $param_item = $row["country"];
        ...
        if($date == 'One Month Last' && !isset($_POST['todate'])){
            ...
            $query="SELECT country, COUNT(*) AS TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE tb_sales.market_id='$item_market' && country!='' && date LIKE '%$param_year_month%' GROUP BY country DESC ORDER BY TOTAL DESC";
            $result = mysqli_query($connect, $query);
            while($row =mysqli_fetch_array($result)) {
                $param_item = $row["country"];
            ...
            $query="SELECT country, COUNT(*) AS TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE tb_sales.market_id='$item_market' && country!='' && date BETWEEN '$date' AND '$todate' GROUP BY country DESC ORDER BY TOTAL DESC";
            $result = mysqli_query($connect, $query);
            while($row =mysqli_fetch_array($result)) {
                $param_item = $row["country"];
            ...
            $query="SELECT country, COUNT(*) AS TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE tb_sales.market_id='$item_market' && country!='' && date LIKE '%$param_year%' GROUP BY country DESC ORDER BY TOTAL DESC";
            $result = mysqli_query($connect, $query);
            while($row =mysqli_fetch_array($result)) {
                $param_item = $row["country"];
            ...
            $query="SELECT country, COUNT(*) AS TOTAL FROM tb_sales INNER JOIN tb_catalog ON tb_sales.item_id=tb_catalog.item_id WHERE tb_sales.market_id='$item_market' && country!='' && date LIKE '%$param_year_1%'  GROUP BY country DESC ORDER BY TOTAL DESC";
            $result = mysqli_query($connect, $query);
            while($row =mysqli_fetch_array($result)) {
