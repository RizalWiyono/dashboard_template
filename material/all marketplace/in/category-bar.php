...
<html>
<head>
    <title>RRGraph - Category Section</title> 
    <meta charset="utf-8">
                    ...
                    <div class="main-sales">
                        <div class="distance-content">
                            <div class="header-content">
                                <h1 class="title-content">Category Section</h1>
                            ...
                            <?php
                                ...
                                ?>
                                    ...
                                    if(isset($_GET['todate'])){
                                    ?>
                                    <a href="?market=All Marketplace&type=All&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                    <?php
                                    }else{
                                    ?>
                                    <a href="?market=All Marketplace&type=All&date=<?=$_GET['date']?>">
                                    <?php
                                    }
                                    ?>
                                ...
                                <h1>
                                    <a href="category-section.php?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>">
                                        setting category
                                    </a>
                                </h1>
                            </div>
                            ...
                            <div class="barchart-content" align="center">
                                <div id="category-chart" class="chart-category"></div>
                                <!-- <canvas id="category-chart" class="chart-category"></canvas> -->
                            </div>
                        </div>
                    </div>
