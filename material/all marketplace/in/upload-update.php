...
<html>
<head>
    <title>RRGraph - Upload and Update</title> 
    <meta charset="utf-8">
...
<body >
                    ...
                    <div class="main-sales">
                        <div class="distance-content">
                            <div class="header-content">
                                <h1 class="title-content">Upload and Update</h1>
                            ...
                            <div class="item-detail">
                                ...
                                <div class="left-upload-update">
                                    <div class="place-upload-update">
                                        <div class="distance-upload-update">
                                            <div class="circle-icon-rrg" align="center">
                                                <img clas src="../../../src/image/TOT-UPLOAD.svg" alt="">
                                            </div>

                                            <h1 id="tot-upload">30</h1>
                                            <p class="total-upload">Total <strong>Upload</strong>
                                                <p id="plus-rate-upl" class="title-rate">+</p>
                                                <p id="title-rate-upl" class="title-rate upload-rate"> 
                                                    <?=number_format(10, 0)?>
                                                    <p id="presentage-upl" class="title-rate">%</p>
                                                    <div id="plus-shape-upl" class="shape-upl" align="center">
                                                        <img id="plus-image-upl" src="../../../src/image/Polygon 1.png" alt="">
                                                    </div>
                                                </p>
                                            </p>
                                        </div>
                                    ...
                                    <div class="place-upload-update" style="margin-top: 6%;">
                                        <div class="distance-upload-update">
                                            <div class="circle-icon-upd" align="center">
                                                <img clas src="../../../src/image/TOT-UPDATE.svg" alt="">
                                            </div>

                                            <h1 id="tot-update">30</h1>
                                            <p class="total-upload">Total <strong>Update</strong>
                                                <p id="plus-rate-upd" class="title-rate">+</p>
                                                <p id="title-rate-upd" class="title-rate update-rate"> 
                                                    <?=number_format(10, 0)?>
                                                    <p id="presentage-upd" class="title-rate">%</p>
                                                    <div id="plus-shape-upd" class="shape-upl" align="center">
                                                        <img id="plus-image-upd" src="../../../src/image/Polygon 1.png" alt="">
                                                    </div>
                                                </p>
                                            </p>
                                        </div>
    ...
    <script src="js/upload-update.js"></script>  
