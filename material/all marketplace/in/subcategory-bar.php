...
<html>
<head>
    <title>RRGraph - Sub Category Section</title> 
    <meta charset="utf-8">
                    ...
                    <div class="main-sales">
                        <div class="distance-content">
                            <div class="header-content">
                                <h1 class="title-content" style="width: 60%;">Category Section
                                    <strong class="param-name">
                                        <?=$_GET['name']?> 
                                        <?php
                                        if(isset($_GET['todate'])){
                                        ?>
                                        <a href="category-bar.php?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                        <?php
                                        }else{
                                        ?>
                                        <a href="category-bar.php?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&date=<?=$_GET['date']?>">
                                        <?php
                                        }
                                        ?>
                                            x
                                ...
                                <div class="range" style="width: 100%;" align="right">
                                    ...
                                    ?>
                                    <a href="?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&name=<?=$_GET['name']?>&date=One Month Last">
                                    ...
                                    ?>
                                    <a href="?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&name=<?=$_GET['name']?>&date=30 Days">
                                    ...
                                    ?>
                                    <a href="?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&name=<?=$_GET['name']?>&date=One Year Last">
                                    ...
                                    <div class="dropdown-menu dd_costum" aria-labelledby="dropdownMenu2">
                                        <a href="?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&name=<?=$_GET['name']?>&date=Last Month" id="last_month" class="dropdown-item" type="button" value="Last Month">Last Month</a>
                                        <a href="?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&name=<?=$_GET['name']?>&date=This Year" id="this_year" class="dropdown-item" type="button" value="This Year">This Year</a>
                                        <a href="?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&name=<?=$_GET['name']?>&date=Last Year" id="last_year" class="dropdown-item" type="button" value="Last Year">Last Year</a>
                                        <a href="?market=<?=$_GET['market']?>&type=<?=$_GET['type']?>&name=<?=$_GET['name']?>&date=All Time" id="all_time" class="dropdown-item" type="button" value="All Time">All Time</a>
                                    </div>
                                    <?php
                                    }else{
                                    ?>
                                    ...
                                    ?>
                                    <button id="costum_sub" class="but-costum but-costum-active">Custom</button>
                                    <?php
                                    }else{
                                    ?>
                                    <button id="costum_sub" class="but-costum">Custom</button>
                                    <?php
                                    }
                                    ?>
                            ...
                            <?php
                                ...
                                ?>
                                    ...
                                    if(isset($_GET['todate'])){
                                    ?>
                                    <a href="?market=All Marketplace&type=All&name=<?=$_GET['name']?>&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                    <?php
                                    }else{
                                    ?>
                                    <a href="?market=All Marketplace&type=All&name=<?=$_GET['name']?>&date=<?=$_GET['date']?>">
                                    <?php
                                    }
                                    ?>
                                ...
                                ?>
                                    ...
                                    if(isset($_GET['todate'])){
                                    ?>
                                    <a href="?market=All Marketplace&type=GR-Brandearth&name=<?=$_GET['name']?>&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                    <?php
                                    }else{
                                    ?>
                                    <a href="?market=All Marketplace&type=GR-Brandearth&name=<?=$_GET['name']?>&date=<?=$_GET['date']?>">
                                    <?php
                                    }
                                    ?>
                                ...
                                ?>
                                    ...
                                    if(isset($_GET['todate'])){
                                    ?>
                                    <a href="?market=All Marketplace&type=GR-RRGraph&name=<?=$_GET['name']?>&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                    <?php
                                    }else{
                                    ?>
                                    <a href="?market=All Marketplace&type=GR-RRGraph&name=<?=$_GET['name']?>&date=<?=$_GET['date']?>">
                                    <?php
                                    }
                                    ?>
                                ...
                                ?>
                                    ...
                                    if(isset($_GET['todate'])){
                                    ?>
                                    <a href="?market=All Marketplace&type=Templatemonster&name=<?=$_GET['name']?>&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                    <?php
                                    }else{
                                    ?>
                                    <a href="?market=All Marketplace&type=Templatemonster&name=<?=$_GET['name']?>&date=<?=$_GET['date']?>">
                                    <?php
                                    }
                                    ?>
                                ...
                                ?>
                                    ...
                                    if(isset($_GET['todate'])){
                                    ?>
                                    <a href="?market=All Marketplace&type=Creativemarket&name=<?=$_GET['name']?>&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                    <?php
                                    }else{
                                    ?>
                                    <a href="?market=All Marketplace&type=Creativemarket&name=<?=$_GET['name']?>&date=<?=$_GET['date']?>">
                                    <?php
                                    }
                                    ?>
                                ...
                                ?>
                                    ...
                                    if(isset($_GET['todate'])){
                                    ?>
                                    <a href="?market=All Marketplace&type=RRSlide&name=<?=$_GET['name']?>&date=<?=$_GET['date']?>&todate=<?=$_GET['todate']?>">
                                    <?php
                                    }else{
                                    ?>
                                    <a href="?market=All Marketplace&type=RRSlide&name=<?=$_GET['name']?>&date=<?=$_GET['date']?>">
                                    <?php
                                    }
                                    ?>
                            ...
                            <div class="barchart-content" align="center">
                                <div id="subcategory-chart" class="chart-category"></div>
                            </div>
                        </div>
                    </div>
