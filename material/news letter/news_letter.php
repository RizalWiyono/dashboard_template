...
<html>
<head>
    <title>RRGraph - News Letter</title> 
    <meta charset="utf-8">
        ...
        <nav align="center">
            ...
            <div class="item"  align="center">
                <ul>
                    ...
                    <li class="sect-active" data-toggle="tooltip" data-placement="right" title="News Letter" id="tool-newsletter">
                        <a id="href-nl" href="">
                    ...
                    <div class="main-sales">
                        <div class="distance-content">
                            <div class="header-content">
                                <h1 class="title-content">News Letter</h1>
                            ...
                            <div class="content">
                                <div class="avg-news-letter-open">
                                    <div class="distance-total-place">
                                        <h1 class="calc-title-rate" id="avg_open_rate">0</h1>
                                ...
                                <div class="avg-news-letter">
                                    <div class="distance-total-place">
                                        <h1 class="calc-title-rate" id="avg_click_rate">0</h1>
                                ...
                                <div class="avg-news-letter">
                                    <div class="distance-total-place">
                                        <h1 class="calc-title-rate" id="avg_unsub_rate">0</h1>
