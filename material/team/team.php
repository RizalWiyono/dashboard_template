        ...
        <nav align="center">
            ...
            <div class="item"  align="center">
                <ul>
                    ...
                    <li class="sect-active" data-toggle="tooltip" data-placement="right" title="Team" id="tool-team">
                ...
                <div class="main-content" align="left">
                    ...
                    <div class="main-header">
                        <select id="selectbox" onchange="location = this.value;">
                            ...
                            <option value="?market=All Marketplace">All Marketplace</option>
                                <?php
                                    include '../../src/connection/connection.php';
                    ...
                    <div class="main-sales">
                        <div class="distance-content">
                            <div class="header-content">
                                <h1 class="title-content">Team</h1>
                            </div>
