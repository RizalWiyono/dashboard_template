...
$query = "DELETE FROM tb_sales WHERE market_id='1'";
mysqli_query($connect, $query);

$query = "DELETE FROM tb_catalog WHERE market_id='1'";
mysqli_query($connect, $query);

$query = "DELETE FROM tb_update WHERE market_id='1'";
mysqli_query($connect, $query);
...
$query = "INSERT INTO tb_activity_template (activity_id, username, activity, date, hours) 
            values 
            (null, '$user', 'Reset All - GR-BE','$date_ac','$hour')";
            mysqli_query($connect, $query);
