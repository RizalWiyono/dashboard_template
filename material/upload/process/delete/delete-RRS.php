...
$query = "DELETE FROM tb_sales WHERE market_id='5'";
mysqli_query($connect, $query);

$query = "DELETE FROM tb_catalog WHERE market_id='5'";
mysqli_query($connect, $query);

$query = "DELETE FROM tb_update WHERE market_id='5'";
mysqli_query($connect, $query);

$query = "DELETE FROM tb_freebies WHERE market_id='5'";
mysqli_query($connect, $query);

$query = "DELETE FROM tb_catalog_fb WHERE market_id='5'";
mysqli_query($connect, $query);

$query = "DELETE FROM tb_update_fb WHERE market_id='5'";
mysqli_query($connect, $query);
