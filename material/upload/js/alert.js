...
var upload = getUrlParameter('upload');
var del = getUrlParameter('success');
...
$("#reset-be").click(function(){

var pass = document.getElementById('username').innerText;

Swal.fire({

    title: "<p style='font-family: Poppins; color: #D70000; font-size: 40px; margin-bottom: -5px;'>GR-Brandearth</p>",
    input: 'password',
    html: "<strong>"+"Are sure want to reset all data"+"</strong>",
    confirmButtonColor: '#007EFF, 100%',
    confirmButtonText: 'Reset!',
    padding: '2em',
}).then((result) => {
    if(result.value){
        var value_pass= md5().fromUTF8((JSON.stringify(result.value)).replace(/['"]+/g, ''));

        if(value_pass === pass){
            location.href = "process/delete/delete-BE.php";
        }
    }else{}
})
});
...
$("#reset-rrg").click(function(){

    var pass = document.getElementById('username').innerText;
    
    Swal.fire({
    
        title: "<p style='font-family: Poppins; color: #D70000; font-size: 40px; margin-bottom: -5px;'>GR-RRGraph</p>",
        input: 'password',
        html: "<strong>"+"Are sure want to reset all data"+"</strong>",
        confirmButtonColor: '#007EFF, 100%',
        confirmButtonText: 'Reset!',
        ...
        if(result.value){
            ...
            if(value_pass === pass){
                location.href = "process/delete/delete-RRG.php";
            }
        }else{}
    })
});
...
$("#reset-tm").click(function(){

    var pass = document.getElementById('username').innerText;
    
    Swal.fire({
    
        title: "<p style='font-family: Poppins; color: #D70000; font-size: 40px; margin-bottom: -5px;'>TemplateMonster</p>",
        input: 'password',
        html: "<strong>"+"Are sure want to reset all data"+"</strong>",
        confirmButtonColor: '#007EFF, 100%',
        confirmButtonText: 'Reset!',
        ...
        if(result.value){
            ...
            if(value_pass === pass){
                location.href = "process/delete/delete-TM.php";
            }
        }else{}
    })
});
...
$("#reset-cm").click(function(){
    ...
    Swal.fire({
        ...
        title: "<p style='font-family: Poppins; color: #D70000; font-size: 40px; margin-bottom: -5px;'>CreativeMarket</p>",
        input: 'password',
        html: "<strong>"+"Are sure want to reset all data"+"</strong>",
        confirmButtonColor: '#007EFF, 100%',
        confirmButtonText: 'Reset!',
        ...
        if(result.value){
            ...
            if(value_pass === pass){
                location.href = "process/delete/delete-CM.php";
            }
        }else{}
    })
});
...
$("#reset-rrs").click(function(){
    var pass = document.getElementById('username').innerText;
    Swal.fire({
    
        title: "<p style='font-family: Poppins; color: #D70000; font-size: 40px; margin-bottom: -5px;'>RRSlide</p>",
        input: 'password',
        html: "<strong>"+"Are sure want to reset all data"+"</strong>",
        confirmButtonColor: '#007EFF, 100%',
        confirmButtonText: 'Reset!',
        ...
        if(result.value){
            ...
            if(value_pass === pass){
                location.href = "process/delete/delete-RRS.php";
            }
        }else{}
    })
});
...
$("#reset-nl").click(function(){

    var pass = document.getElementById('username').innerText;
    
    Swal.fire({
    
        title: "<p style='font-family: Poppins; color: #D70000; font-size: 40px; margin-bottom: -5px;'>News Letter</p>",
        input: 'password',
        html: "<strong>"+"Are sure want to reset all data"+"</strong>",
        confirmButtonColor: '#007EFF, 100%',
        confirmButtonText: 'Reset!',
        ...
        if(result.value){
            ...
            if(value_pass === pass){
                location.href = "process/delete/delete-NL.php";
            }
        }else{}
    })
});
...
$("#reset-dp").click(function(){
    ...
    Swal.fire({
        ...
        title: "<p style='font-family: Poppins; color: #D70000; font-size: 40px; margin-bottom: -5px;'>Data Popular</p>",
        input: 'password',
        html: "<strong>"+"Are sure want to reset all data"+"</strong>",
        confirmButtonColor: '#007EFF, 100%',
        confirmButtonText: 'Reset!',
        ...
        if(result.value){
            ...
            if(value_pass === pass){
                location.href = "process/delete/delete-DP.php";
            }
        }else{}
    })
});