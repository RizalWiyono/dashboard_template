...
if($date_range == 'This Month'){
    ...
    foreach($daterange as $dt){
        ...
        $sql_tb_catalog = mysqli_query($connect, "SELECT SUBSTR('$date_value', 9) AS day, SUBSTR('$date_value', 1, 4) AS year, SUBSTR('$date_value', 6, 2) AS month, COUNT(*) AS JUMLAH FROM tb_freebies  WHERE date = '$date_value'");
    ...
    foreach($daterange2 as $dt2){
        ...
        $sql_popular = mysqli_query($connect, "SELECT SUBSTR('$date_value2', 9) AS day, SUBSTR('$date_value2', 1, 4) AS year, SUBSTR('$date_value2', 6, 2) AS month, COUNT(*) AS TOTAL FROM tb_freebies  WHERE date = '$date_value2'");
    ...
    (SELECT  COUNT(*) FROM tb_freebies WHERE date BETWEEN '$param_date_2' AND '$param_date_1' and day = a.day) as TOTAL, 
    (SELECT COUNT(*) FROM tb_freebies WHERE date BETWEEN '$param_date_1' AND '$param_date' and day = a.day) as JUMLAH 
    ...
    foreach($period2 as $dt2){
        ...
        $sql_tb_catalog = mysqli_query($connect, "SELECT SUBSTR('$date_value2', 9) AS day, SUBSTR('$date_value2', 1, 4) AS year, SUBSTR('$date_value2', 6, 2) AS month, COUNT(*) AS JUMLAH FROM tb_freebies WHERE date LIKE '%$date_value2%'");
        while($row = mysqli_fetch_array($sql_tb_catalog)){
            $rows[] = $row;
        }
    }
    ...
    foreach($period4 as $dt4){
        ...
        $sql_popular = mysqli_query($connect, "SELECT SUBSTR('$date_value4', 9) AS day, SUBSTR('$date_value4', 1, 4) AS year, SUBSTR('$date_value4', 6, 2) AS month, COUNT(*) AS TOTAL FROM tb_freebies WHERE date LIKE '%$date_value4%'");
        while($data = mysqli_fetch_array($sql_popular)){
            $rowss[] = $data;
    ...
    (SELECT COUNT(*) FROM tb_freebies WHERE date BETWEEN '$date_1' AND '$date_2' and day = a.day) as TOTAL, 
    (SELECT COUNT(*) FROM tb_freebies WHERE date BETWEEN '$date' AND '$todate' and day = a.day) as JUMLAH 
    ...
    if(mysqli_num_rows($update_sql) > 50){
        ...
        (SELECT COUNT(*) FROM tb_freebies WHERE date BETWEEN '$date_1' AND '$date_2' and month = a.month) as TOTAL, 
        (SELECT COUNT(*) FROM tb_freebies WHERE date BETWEEN '$date' AND '$todate' and month = a.month) as JUMLAH 
        FROM (SELECT DISTINCT month, year FROM tb_freebies WHERE date BETWEEN '$date' AND '$todate' GROUP BY month ORDER BY year DESC, month DESC) a";
        $result = mysqli_query($connect, $query);
        while($row =mysqli_fetch_array($result)) {
            $output[] = [
    ...
    $query="SELECT year, a.month, 
    (SELECT COUNT(*) FROM tb_freebies WHERE year=$param_year_2 and month = a.month) as TOTAL, 
    (SELECT COUNT(*) FROM tb_freebies WHERE year=$param_year_1 and month = a.month) as JUMLAH 
    ...
    $query="SELECT a.year, 
    (SELECT  COUNT(*) FROM tb_freebies WHERE year = a.year) as TOTAL, 
    (SELECT COUNT(*) FROM tb_freebies WHERE year = a.year) as JUMLAH 
    ...
    $query="SELECT year, a.month, 
    (SELECT  COUNT(*) FROM tb_freebies WHERE year=$param_year_1 and month = a.month) as TOTAL, 
    (SELECT COUNT(*) FROM tb_freebies WHERE year=$param_year and month = a.month) as JUMLAH 
